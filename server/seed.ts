...
async function seedBscData(companyId: number) {
  ...
  const store: Record<string, Record<string, number>> = {
    "2025-10": {
      ...
      it_i1:5, m_it_i1:10, it_c1:82, it_i2:78, it_c2:88, it_i3:55, it_c3:2.8, it_l1:65, it_l2:1, it_i4:6, it_f1:108, it_i5:0, it_i6:65, it_c4:4,
    },
    "2025-11": {
      ...
      it_i1:18, m_it_i1:20, it_c1:84, it_i2:81, it_c2:90, it_i3:52, it_c3:3.0, it_l1:70, it_l2:2, it_i4:8, it_f1:105, it_i5:0, it_i6:70, it_c4:3,
    },
    "2025-12": {
      ...
      it_i1:30, m_it_i1:30, it_c1:85, it_i2:84, it_c2:92, it_i3:50, it_c3:3.0, it_l1:75, it_l2:3, it_i4:9, it_f1:103, it_i5:0, it_i6:76, it_c4:2,
    },
    "2026-01": {
  ...
  console.log(`Seed: created BSC departments (Corporate, Engineering, Operations, Finance, HR) and 7 months of actuals`);
}
