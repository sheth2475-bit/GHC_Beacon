...
export async function seedDatabase() {
  ...
  const company = await storage.createCompany({
    userId: user.id,
    companyName: "Sheth Offshore Helicopters",
    industry: "Offshore Helicopters",
    companySize: "51-200",
    country: "UAE",
  });
