...
export const kpis = pgTable("kpis", {
  ...
  targetType: text("target_type").default("numeric"),
  targetDate: text("target_date"),
  targetFrequency: text("target_frequency").default("monthly"),
  milestoneStartDate: text("milestone_start_date"),
...
export const kpiActuals = pgTable("kpi_actuals", {
  ...
  milestoneTarget: text("milestone_target"),
