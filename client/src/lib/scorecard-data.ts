...
export const DEPT_KPIS: Record<string, KpiDef[]> = {
  ...
  hr: [
    ...
    { id:"hr_c3",  name:"Time to Resolve Employee Issues (days)",                  perspective:"Customer",  unit:"days", target:10,  lowerIsBetter:true },
    { id:"hr_c4",  name:"Grievance Resolution Time (days)",                        perspective:"Customer",  unit:"days", target:10,  lowerIsBetter:true },
    // Internal Process
    { id:"hr_i1",  name:"Development & Sign-off of HR Policy",                    perspective:"Internal",  unit:"%",    target:100, targetType:"milestone_date", targetDate:"2026-06", milestoneStartDate:"2026-01" },
    ...
    { id:"hr_i5",  name:"Time to Hire (days) – Job Open to Offer Acceptance",     perspective:"Internal",  unit:"days", target:40,  lowerIsBetter:true },
    { id:"hr_i6",  name:"Time to Fill (days) – Offer Acceptance to Onboarding",   perspective:"Internal",  unit:"days", target:100, lowerIsBetter:true },
    ...
    { id:"hr_l2",  name:"Hiring of N-1 & N-2 per Approved Org. Chart %",          perspective:"Learning",  unit:"%",    target:100 },
  ],
  qhse: [
