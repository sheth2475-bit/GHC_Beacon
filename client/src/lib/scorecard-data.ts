...
export const DEPT_KPIS: Record<string, KpiDef[]> = {
  ...
  it: [
    ...
    { id:"it_i3", name:"Incident Resolution Time",           perspective:"Internal", unit:"hrs",target:48 },
    { id:"it_c3", name:"IT Satisfaction Score",              perspective:"Customer", unit:"/5", target:3,   targetFrequency:"annual" },
    { id:"it_l1", name:"IT Training Participation Rate",     perspective:"Learning", unit:"%",  target:90 },
    { id:"it_l2", name:"Cybersecurity Awareness Activities", perspective:"Learning", unit:"#",  target:4 },
    { id:"it_i4", name:"Security Incident Reports & Actions",perspective:"Internal", unit:"#",  target:12 },
    { id:"it_f1", name:"IT Budget Adherence",                perspective:"Financial",unit:"%",  target:100, lowerIsBetter:true },
    { id:"it_i5", name:"Process & Procedure Update Rate",    perspective:"Internal", unit:"%",  target:90 },
