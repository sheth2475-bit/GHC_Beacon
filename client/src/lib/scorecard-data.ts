...
export const DEPT_KPIS: Record<string, KpiDef[]> = {
  ...
  it: [
    ...
    { id:"it_l2", name:"IT Cybersecurity & System Awareness Activities",     perspective:"Learning", unit:"#",  target:4 },
    { id:"it_i4", name:"Monthly Security Incident Reporting & Improvement",  perspective:"Internal", unit:"#",  target:12 },
