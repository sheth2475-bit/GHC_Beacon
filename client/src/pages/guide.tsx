...
import {
  LayoutDashboard, Target, ListChecks, CalendarDays, Briefcase,
...
const MODULES = [
  ...
  },
  {
    ...
    readingGuide: [
      ...
      { area: "Title & description", desc: "The action item title (e.g. 'Update budget forecast for Q2') and a brief description. Click the pencil icon to edit." },
      { area: "Owner column", desc: "The person responsible for completing this action. They appear in the Workload page too." },
      { area: "Due Date", desc: "The agreed deadline. Dates shown in orange or red are overdue — they also appear in the Dashboard's Overdue Actions count and trigger a notification." },
      { area: "Revised Due Date", desc: "If the due date changes, the revised date is logged here. Useful for tracking whether deadlines are slipping." },
    ...
    actions: [
      ...
      { step: "4", text: "Set a Due Date and Priority" },
  ...
  },
  {
    ...
    screenshot: null,
    screenshotAlt: "",
    overview: "The Meetings module logs every meeting you run — dates, attendees, agenda items, and discussion notes. Logged meetings link directly to the actions they generate in the Action Tracker.",
    readingGuide: [
      { area: "Meeting title & date", desc: "The meeting name (e.g. 'Monthly CEO Review — March 2026') and the date it took place. Use a consistent naming convention so you can find past meetings easily." },
      { area: "Meeting type", desc: "Choose from CEO Meeting, Department Review, PMO Steering Committee, Board Meeting, or Custom. The type flows through to the Action Tracker." },
      { area: "Attendees field", desc: "List all participants. This helps you identify who was accountable for decisions made in the meeting." },
      { area: "Agenda items", desc: "What was discussed — add each agenda item as a separate line. This is the record of what was covered, not what was decided." },
      { area: "Notes / decisions", desc: "Key decisions made and important discussion points. This is the official meeting record." },
      { area: "Actions tab", desc: "After logging the meeting, switch to the Actions tab to add any commitments made during the session. These appear in the Action Tracker." },
    ],
    actions: [
      { step: "1", text: "Click + New Meeting after (or before) your meeting" },
      { step: "2", text: "Enter the meeting title, date, and type" },
      { step: "3", text: "Add attendees" },
      { step: "4", text: "Log agenda items and key decisions" },
      { step: "5", text: "Switch to the Actions tab and add any commitments with owners and due dates" },
      { step: "6", text: "Save — the actions appear in the Action Tracker immediately" },
    ],
  },
  {
    id: "portfolio",
    ...
    readingGuide: [
      ...
      { area: "Owner & deadline", desc: "Project owner and planned end date. If the end date has passed and progress is not 100%, the project turns Red." },
      { area: "Task count", desc: "e.g. '1/4 tasks' = 1 task completed out of 4 total. Click the card to see the full task list." },
    ],
    actions: [
      { step: "1", text: "Click + New Project and enter the project name, description, owner, and deadline" },
  ...
  },
  {
    ...
    overview: "The AI Assistant reads all your business data — KPIs, actions, meetings, projects, and reviews — and answers plain-English questions. Ask it anything about your performance.",
    readingGuide: [
      { area: "Open Assistant button", desc: "Click the sparkle ✦ Assistant button in the top-right header from any page. The drawer slides in without leaving your current view." },
      ...
      { area: "AI response", desc: "The assistant responds with structured analysis — bullet points, tables, and specific numbers pulled from your data. Bold figures are your actual KPI values." },
      ...
      { area: "Suggested actions", desc: "After answering, the AI may suggest next steps (e.g. 'Go to Action Tracker', 'View KPI Management'). Click the links to navigate directly." },
    ],
    actions: [
      ...
      { step: "6", text: "Each day limit: AI requests reset at midnight. Check Settings > Subscription to see your remaining requests." },
    ],
  },
];
